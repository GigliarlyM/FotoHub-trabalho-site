...
function RenderPhotos () {
    ...
    const uriApi = import.meta.env.VITE_APP_API_URL + `/art`
    ...
    return (
        <>
            {photos.map(photo => <Photo titulo={photo.titulo} className="photo" url={photo.imagem} price={photo.valor} promo={0} />)}
        </>
    )
}